...
<html>
  ...
  <body role="document">
	...
	<div class="container theme-showcase" role="main">
		...
		<!-- 아래에 실제내용 표시 -->
		<div>
			<form action="${pageContext.request.contextPath}/ZAMONG/ZamongTVEdit.do" method="post">
			<!-- 키값 -->
		       <input type="hidden" name="tv_no" value="${dto.tv_no}"/>번호 : ${dto.tv_no}
				<table class="table table-striped" style="">
					...
					<tr bgcolor="white">
              			<td>제목</td>
              			<td >
              			<input type="text" name="tv_title" style="width:80%" value="${dto.tv_title }"/>
              			</td>
		            </tr>
					<tr>
						<td>내용</td>
						<td><textarea cols="120" rows="20" name="tv_content">${dto.tv_contents }</textarea>
						</td>
					</tr>
					<tr>
					<!-- <input type="hidden" name="ad_no" /> -->
						<td>링크</td>
						<td>
						 <input type="text"  name="tv_link" style="width:80%" value='${dto.tv_link }'/>
						</td>					
					</tr>
					<tr align="center">
					<td colspan="50">
