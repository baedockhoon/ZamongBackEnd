  ...
  <body role="document">
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="page-header">
			<h1>뮤직어워드 게시물 작성하기</h1>
		</div>
		<!-- 아래에 실제내용 표시 -->
		<div>
			<form action="${pageContext.request.contextPath}/ZAMONG/MusicAwardWrite.do" method="post" name="p_form">
				<table class="table table-striped" style="">
					...
					<!-- <input type="hidden" name="ad_no" /> -->
						<td>어워드 종료일자</td>
						<td>
						 <input type="text" name="endofday" style="width:10%" id="testDatepicker"/>
