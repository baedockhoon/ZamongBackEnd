...
public class ProblemListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		map.put("end",end);
		//페이징을 위한 로직 끝]	
		List<ProblemDTO> list= dao.selectList(map);
		
		//페이징용 문자열 생성
		String pagingString = PagingUtil.pagingText(totalRecordCount, pageSize, blockPage, nowPage, req.getServletContext().getContextPath()+"/ZAMONG/ProblemList.do?");
		...
		RequestDispatcher dispatcher=req.getRequestDispatcher("/bbs/notice/ProblemList.jsp");
